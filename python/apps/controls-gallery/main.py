...
async def main(page: ft.Page):
    ...
    async def display_control_examples(control_group_name, control_id):
        ...
        for example in grid_item.examples:
            example_content = (
                ...
                if is_coroutine(example.example)
            ...
            listview.controls.append(
                ft.Column(
                    controls=[
                        ...
                        ft.Row(
                            controls=[
                                ft.Container(content=example_content),
                            ]
                        ),
                    ]
                )
    ...
    async def control_group_selected(e):
        ...
        await display_control_group(control_group_name)
    ...
    page.add(
        ft.Row(
            [rail, ft.VerticalDivider(width=1), grid, examples],
            expand=True,
        )
    )
